class NflTeams::Scraper
    ...
    #         # new_schedule = NflTeams::Schedule.new
    #         # new_schedule.team = team_selection
    #         # new_schedule.week = game.css("p.nfl-o-matchup-cards__date-info strong").text
    #         # new_schedule.date = game.css("p.nfl-o-matchup-cards__date-info span").text
    #         # new_schedule.opponent = game.css("p.nfl-o-matchup-cards__team-full-name").text.strip
    #         # new_schedule.location = game.css("span.nfl-o-matchup-cards__venue--location").text.strip 
    #     end
    #  end
end